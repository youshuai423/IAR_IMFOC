...
#define GFLIB_CtrlPIDrInit_FLT(fltInitVal, psParam)                         GFLIB_CtrlPIDrInit_FLT_Ci(fltInitVal, psParam)        
#define GFLIB_CtrlPIDr_FLT(fltInErr, psParam)                               GFLIB_CtrlPIDr_FLT_C(fltInErr, psParam)    
...
#define GFLIB_CtrlPIrInit_FLT(fltInitVal, psParam)                          GFLIB_CtrlPIrInit_FLT_Ci(fltInitVal, psParam)  
#define GFLIB_CtrlPIrLimInit_FLT(fltInitVal, psParam)                       GFLIB_CtrlPIrLimInit_FLT_Ci(fltInitVal, psParam) 
#define GFLIB_CtrlPIrLim_FLT(fltInErr, psParam)                             GFLIB_CtrlPIrLim_FLT_C(fltInErr, psParam)    
#define GFLIB_CtrlPIr_FLT(fltInErr, psParam)                                GFLIB_CtrlPIr_FLT_C(fltInErr, psParam)   
