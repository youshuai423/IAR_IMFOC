...
#if defined(__IAR_SYSTEMS_ICC__) /* IAR compiler   */
    #define FSLESL_NAN ((float_t)(0.Nan))                  /* 0x7FFFFFFF = quiet NaN */
#elif defined(__CC_ARM)          /* ARM(KEIL) compiler */
    #define FSLESL_NAN (__ESCAPE__(0f_7FC00000))           /* 7FC00000 = Quiet NaN */
#else                            /* GCC(KDS) compiler */
    #define FSLESL_NAN ((float_t)0x7FC00000)               /* 7FC00000 = Quiet NaN */
#endif
