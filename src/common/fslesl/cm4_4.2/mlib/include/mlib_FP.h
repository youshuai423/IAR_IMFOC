...
#define MLIB_Mac_FLT(a32Accum, fltMult1, fltMult2)                                  MLIB_Mac_FLT_Ci(a32Accum, fltMult1, fltMult2)
...
#define MLIB_Msu_FLT( a32Accum, fltMult1, fltMult2)                                 MLIB_Msu_FLT_Ci( a32Accum, fltMult1, fltMult2)
#define MLIB_MulNeg_FLT( a32Accum, fltMult)                                         MLIB_MulNeg_FLT_Ci( a32Accum, fltMult)
#define MLIB_Mul_FLT( a32Accum, fltMult)                                            MLIB_Mul_FLT_Ci( a32Accum, fltMult) 
#define MLIB_Neg_FLT(fltVal)                                                        MLIB_Neg_FLT_Ci(fltVal) 
#define MLIB_Rcp_FLT(fltDenom)                                                      MLIB_Rcp_FLT_Ci(fltDenom)             
