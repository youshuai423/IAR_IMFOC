...
* @remarks 
*
* Function does not devide sum(k) by 2^n but multiply sum(k) by float number Coef, 
* which is not determined by power of 2. For eample if filter window size 4 is 
